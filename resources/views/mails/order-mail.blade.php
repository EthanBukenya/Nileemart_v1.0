        ...
        <tbody>
            ...
            @endforeach
                <tr>
                    ...
                    <td style="font-size: 15px; font-weight: bold; border-top: 1px solid #ccc;">Subtotal : AED{{$order->subtotal}}</td>
                </tr>
                <tr>
                    <td colspan="3"></td>
                    <td style="font-size: 15px; font-weight: bold;">VAT : AED{{$order->tax}}</td>
                </tr>
                <tr>
                    <td colspan="3"></td>
                ...
                <tr>
                    <td colspan="3"></td>
                    <td style="font-size: 22px; font-weight: bold;">Total : AED{{$order->total}}</td>
                </tr>
        </tbody>
    </table>
