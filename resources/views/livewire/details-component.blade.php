				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
							...
							@else
                            	<div class="wrap-price"><span class="product-price">AED {{ $product->sale_price }}</span></div>
							@endif
							...
							<div class="wrap-butons">
                                ...
                                <div class="wrap-btn">
                                    ...
                                    <a href="#" wire:click.prevent="addToWishlist({{$product->id}}, '{{$product->name}}', {{ $product->sale_price }})" class=" btn-wishlist">Add Wishlist</a>
                                </div>
							</div>
						</div>
								...
								<li class="service">
									<a class="link-to-service" href="#">
										...
										<div class="right-content">
											...
											<span class="subtitle">On Orders Over AED 500</span>
											<p class="desc"></p>
										</div>
									</a>
								</li>
								...
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">AED {{ $p_product->sale_price}}</span></div>
										</div>
									</div>
								</li>
                            @endforeach
				...
				<div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="wrap-show-advance-info-box style-1 box-in-site">
						...
						<div class="wrap-products">
							<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"2"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                                @foreach ($related_products as $r_product)
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">AED {{ $r_product->sale_price }}</span></div>
                                        </div>
                                    </div>
                                @endforeach
							</div>
