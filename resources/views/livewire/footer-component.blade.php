<div>
    <footer id="footer">
		<div class="wrap-footer-content footer-style-1">
			...
			<div class="col-lg-12 wrap-function-info" style="color: #010ff4;">
				<div class="container">
					<ul>
					    <!--
						<li class="col-md-6 col-sm-6 col-xs-6 fc-info-item">
							<i class="fa fa-truck" aria-hidden="true"></i>
							<div class="wrap-left-info">
								<h4 class="fc-name" style="color: #010ff4;">Free Shipping</h4>
						...
						<li class="col-md-6 col-sm-6 col-xs-6 fc-info-item">
							...
							<div class="wrap-left-info">
								<h4 class="fc-name" style="color: #010ff4;">Guarantee</h4>
						...
						<li class="col-md-6 col-sm-6 col-xs-6 fc-info-item">
							...
							<div class="wrap-left-info">
								<h4 class="fc-name" style="color: #010ff4;">Safe Payment</h4>
						...
						<li class="col-md-6 col-sm-6 col-xs-6 fc-info-item">
							...
							<div class="wrap-left-info">
								<h4 class="fc-name" style="color: #010ff4;">Online Support</h4>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2022 Smaster Business Creations LLC. All rights reserved</p>
					</div>
