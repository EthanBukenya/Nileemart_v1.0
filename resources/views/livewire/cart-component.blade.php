						...
						@if (Cart::instance('cart')->count() > 0)
							...
							@foreach(Cart::instance('cart')->content() as $item)
								<li class="pr-cart-item">
									...
									<div class="price-field produtc-price"><p class="price">AED {{$item->model->sale_price}}</p></div>
									<div class="quantity">
					...
					<div class="summary">
						<div class="order-summary">
							...
							@if(Session::has('coupon'))
								...
								<p class="summary-info"><span class="title">VAT <!-- ({{config('cart.tax')}}%) --></span><b class="index">AED {{number_format($taxAfterDiscount,2)}}</b></p> 
								<p class="summary-info total-info "><span class="title">Total</span><b class="index">AED {{number_format($totalAfterDiscount,2)}}</b></p>
							@else
								<p class="summary-info"><span class="title">VAT </span><b class="index"><!-- AED {{Cart::instance('cart')->tax()}} --> VAT inclusive</b></p>
								<p class="summary-info"><span class="title">Shipping</span><b class="index">Free on orders above AED 500</b></p>
