...
<body class="home-page home-01">
	...
	<!--header-->{{--}}
	<header id="header" class="header" header-style-1 style="background-color: #369863">  <!--class="header header-style-1" -->
		<div class="container-fluid" style="background-color: #369863">
			<div class="row">
				<div class="topbar-menu-area" style="background-color: #369863">
					<div class="container">
				...
				<div class="container">
					<div class="mid-section main-info-area" style="background-color: #369863">
				...
				<div class="nav-section " style="background-color: #369863">
                    <!--
					...
					<div class="primary-nav-section" style="background-color: #369863">
						<div class="container">
    ...
    <!--end of header-->
    	...
    	<!--header-->
	<header id="header" class="header header-style-1" style="background-color: #369863">
		<div class="container-fluid" style="background-color: #369863">
			<div class="row">
				<div class="topbar-menu-area" style="background-color: #369863">
					<div class="container">
				...
				<div class="nav-section" style="background-color: #369863"><!--header-sticky removed-->
...
<body>
    ...
    <header style="background-color: #369863">
        <div class="container-fluid cont_color">
                <div class="header-top-wrapper-21 border-bottom-21">
                    <div class="header-info-wrapper21 pl-200 pr-200">
                        <div class="logo-321">
                            <a href="{{route('home')}}">
                                <img src="/assets/img/icon-img/LOGO ICON-1.png" alt="" width="100px" height="100px">
                            </a>
                        </div>
                        <div class="header-contact-info21">
                            <ul>
                        ...
                        <div class="smaster-heading21">
                            <div class="container">
                                <div class="row">
                                <div class="col-lg-12">
                                <!-- <img src="/assets/img/icon-img/1652885545423_BE SHOPPING MASTER ICON.png" alt="" width="300px" height="100px"> -->
                                <h4><img src="/assets/img/icon-img/1653158120074_GROCERY ICON.png" alt="" width="60px" height="60px">SUPER MASTER</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <!-- <div class="container-fluid">
                        ...
                        <div class="electronics-login-register21">
                            <ul>
                                ...
                                <!--<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">-->
                                    ...
                                    <div class="trace-cart-wrapper21">
                                        <div class="trace same-style21">
                                            <div class="same-style-icon21">
        ...
        <div class="header-bottom21 clearfix">
            <div class="header-bottom-wrapper21 pr-200 pl-200">
