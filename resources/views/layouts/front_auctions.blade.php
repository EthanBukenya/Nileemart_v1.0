...
<body class="home-page home-01">
	...
	<!--header-->{{--}}
	<header id="header" class="header" header-style-1 style="background-color: #50071b">  <!--class="header header-style-1" -->
		<div class="container-fluid" style="background-color: #50071b">
			<div class="row">
				<div class="topbar-menu-area" style="background-color: #50071b">
					<div class="container">
				...
				<div class="container">
					<div class="mid-section main-info-area" style="background-color: #50071b">

						<div class="wrap-logo-top left-section">
                        <a href="{{'/home'}}" class="link-to-home"><img src="{{ asset('assets/img/icon-img/LOGO ICON-1.png') }}" alt="" width="100px" height="100px"></a>
						</div>
				...
				<div class="nav-section " style="background-color: #50071b">
                    <!--
					...
					<div class="primary-nav-section" style="background-color: #50071b">
						<div class="container">
    ...
    <!--end of header-->
    	...
    	<!--header-->
	<header id="header" class="header header-style-1" style="background-color: #50071b">
		<div class="container-fluid" style="background-color: #50071b">
			<div class="row">
				<div class="topbar-menu-area" style="background-color: #50071b">
					<div class="container">
				...
				<div class="nav-section" style="background-color: #50071b"><!--header-sticky removed-->
...
<body>
    ...
    <header style="background-color: #50071b">
        <div class="container-fluid cont_color24">
                <div class="header-top-wrapper-24 border-bottom-21">
                    <div class="header-info-wrapper24 pl-200 pr-200">
                        <div class="logo-321">
                            <a href="{{route('home')}}">
                                <img src="/assets/img/icon-img/LOGO ICON-1.png" alt="" width="100px" height="100px">
                            </a>
                        </div>
                        <div class="header-contact-info24">
                            <ul>
                        ...
                        <div class="smaster-heading24">
                            <div class="container">
                                <div class="row">
                                <div class="col-lg-12">
                                <!-- <img src="/assets/img/icon-img/1652885545423_BE SHOPPING MASTER ICON.png" alt="" width="300px" height="100px"> -->
                                <h4><img src="/assets/img/icon-img/1653157948772_AUCTION ICON.png" alt="" width="60px" height="60px">SMASTER AUCTION</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <!-- <div class="container-fluid">
                        ...
                        <div class="electronics-login-register24">
                            <ul>
                                ...
                                <!--<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">-->
                                    ...
                                    <div class="trace-cart-wrapper24">
                                        <div class="trace same-style24">
                                            <div class="same-style-icon24">
        ...
        <div class="header-bottom24 clearfix">
            <div class="header-bottom-wrapper24 pr-200 pl-200">
        ...
        <div class="mobile-menu-area electro-menu d-md-block col-md-12 col-lg-12 col-12 d-lg-none d-xl-none">
            <div class="mobile-menu">
                ...
                <li><a href="{{ route('auctions.index') }}">AUCTIONS <span class="sticker-new">hot</span></a></li>
