		...
		mercado_clone_all_zan_menus: function() {
			...
			$('.clone-main-menu').each(function () {
				...
				if (!$('#' + this_menu_clone_id).length) {
					...
					// Create main panel if not exists ////initial id=mercado-main-panel changed to mercado-panel-mercado_main
					if(!$('.mercado-clone-wrap .mercado-panels #mercado-panel-mercado_main').length){
						$('.mercado-clone-wrap .mercado-panels').append('<div id="mercado-panel-mercado_main" class="mercado-panel mercado-main-panel"><ul class="depth-01"></ul></div>');
					}
